          ...
          <ul className='flex absolute top-0 right-145 m-2 '>
            ...
            {/* <div className='dropdown'>
              <button
                ...
                class=" text-white hover:shadow-lg ml-2" type="button">
                Sales
              <ul className=" text-center mt-3 text-blue-500 font-bold space-y-2 bg-gradient-to-r h-20 w-22 from-blue-800 to-purple-950">
                <li><a className='border-b-2 p-1  hover:text-blue-800'>Monthly</a></li>
                <li><a className='border-b-2 p-1  hover:text-blue-800'>Yearly</a></li>
              </ul>
              </button>
...
<div class="relative h-30 mt-15">
  <div class="absolute inset-0 flex flex-col sm:flex-row sm:items-center sm:justify-around gap-4 sm:gap-0 dark:text-blue-600 m-4">
   
    <div class="bg-white p-2 rounded-lg shadow-lg w-full sm:w-40 h-20">
      <svg class="w-10 h-10 mr-1 text-gray-800 dark:text-blue-600 float-right" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4.5V19a1 1 0 0 0 1 1h15M7 14l4-4 4 4 5-5m0 0h-3.207M20 9v3.207" />
      </svg>
      <h2 class="float-left text-md text-purple-500 ml-1">4,546,405</h2>
      <p class="text-sm float-left ml-1 mt-1">YTD TP Value</p>
    </div>
    ...
    <div class="bg-white p-2 rounded-lg shadow-lg w-full sm:w-40 h-20">
      ...
      <h2 class="float-left text-md text-purple-500 ml-1">56520,352</h2>
      <p class="text-sm float-left ml-1 mt-1">YTD TP Target</p>
    </div>
    
    <div class="bg-white p-2 rounded-lg shadow-lg w-full sm:w-40 h-20">
      <svg class="w-10 h-10 mr-1 mt-1 text-gray-800 dark:text-blue-600 float-right" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 4h1.5L9 16m0 0h8m-8 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm8 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm-8.5-3h9.25L19 7H7.312" />
      </svg>
      <h2 class="float-left text-md text-purple-500">35.0%</h2>
      <p class="text-sm float-left mt-2 ml-2">YTD TP Percentage</p>
    </div>
   
    <div class="bg-white p-2 rounded-lg shadow-lg w-full sm:w-40 h-20">
      <svg class="w-10 h-10 mr-1 mt-1 text-gray-800 dark:text-blue-600 float-right" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
      ...
      <p class="text-sm float-left ml-2 mt-2">YTD ACH UCC</p>
    </div>
  </div>
</div>
        ...
        <div className="flex flex-row lg:flex-row justify-between flex-wrap gap-2">
 
  <div className="flex h-80 w-full lg:w-[40rem] m-2 p-4 bg-white rounded-lg shadow-lg">
    <Bar
      data={{
  ...
  <div className="h-80 w-full lg:w-[40rem] m-2 p-4 bg-white rounded-lg shadow-lg">
    <Line
      data={{
        labels: ['June', 'July', 'Aug', 'Sept', 'Oct', 'Nov', 'Dec', 'Jan', 'Feb'],
        datasets: [
          ...
          <div className="flex justify-center mb-4">
            {tabs.map((tab, index) => (
              <button
                ...
                key={`tab_${index}`}
                className={`px-4 py-2 mx-2 rounded-md ${activeTab === index
