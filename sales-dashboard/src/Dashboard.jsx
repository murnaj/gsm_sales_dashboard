...
const Dashboard = () => {
  ...
  <div className="flex items-center justify-between p-2">
    ...
    <div className="relative">
      ...
      {isSidebarOpen && (
        <div className="absolute top-0 left-0 w-64 h-screen bg-gradient-to-r from-blue-800 to-purple-950 text-white shadow-lg z-50">
          ...
          <ul className="p-4 space-y-4">
            <li>
              <a
                href="#"
                className="block hover:text-blue-400 font-serif border-b-2 pb-2">Dashboard</a>
            </li>
            <li>
              <a href="#" className="block hover:text-blue-400 font-serif border-b-2 pb-2">Customers</a>
            </li>
            <li>
              <a href="#" className="block hover:text-blue-400 font-serif border-b-2 pb-2">Sales</a>
            </li>
            <li>
              <a
                href="#"
                className="block hover:text-blue-400 font-serif border-b-2 pb-2"
              >
                Reports
              </a>
            </li>
       ...
       <span className=' text-slate-700 font-bold mx-2'>PERFORMANCE</span>
        ...
        <div class="relative h-35 mt-15">
          <div class="absolute inset-0 flex flex-col sm:flex-row sm:items-center sm:justify-around gap-4 sm:gap-1 dark:text-blue-600 m-4">
            ...
            <div class="bg-white p-2 rounded-lg shadow-lg w-full sm:w-50 h-30">
              ...
              <p class="text-sm float-left mt-1 ml-2">YTD TP Percentage</p>
            </div>
            ...
            <div class="bg-white p-2 rounded-lg shadow-lg w-full sm:w-50 h-30">
              ...
              <div className='flex flex-col'>
                ...
                <p class="text-sm float-left  mt-2">YTD ACH UCC</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="relative h-35 mt-15">
          <div class="absolute inset-0 flex flex-col sm:flex-row sm:items-center sm:justify-around gap-4 sm:gap-1 dark:text-blue-600 m-4">
            ...
            <div class="bg-white p-2 rounded-lg shadow-lg w-full sm:w-50 h-30">
              <svg class="w-10 h-20 mr-1 mt-1 text-gray-800 dark:text-blue-600 float-right" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                <path d="M6 2c-1.10457 0-2 .89543-2 2v4c0 .55228.44772 1 1 1s1-.44772 1-1V4h12v7h-2c-.5523 0-1 .4477-1 1v2h-1c-.5523 0-1 .4477-1 1s.4477 1 1 1h5c.5523 0 1-.4477 1-1V3.85714C20 2.98529 19.3667 2 18.268 2H6Z" />
                <path d="M6 11.5C6 9.567 7.567 8 9.5 8S13 9.567 13 11.5 11.433 15 9.5 15 6 13.433 6 11.5ZM4 20c0-2.2091 1.79086-4 4-4h3c2.2091 0 4 1.7909 4 4 0 1.1046-.8954 2-2 2H6c-1.10457 0-2-.8954-2-2Z" />
              </svg>
              <div className='flex flex-col'>
        ...
        <div className="flex flex-row md:flex-row justify-center flex-wrap gap-4 m-2 p-2 mt-45 ">
